/**
 * @file
 * @brief Contains the TAC class and all the sub classes.
 */
...
class TAC
{
 public:
  ...
  /**
   * @brief Write TAC information to dot file.
   *
   * @param f Dot file stream.
   */
  virtual void generate_tree_content(std::ofstream* f) = 0;
  /**
   * @brief Write TAC to binary file.
   *
   * @param f file stream.
   */
  virtual void generate_code(std::ofstream* f) = 0;
};
