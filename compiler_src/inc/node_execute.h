/**
 * @file
 * @brief Containing all subclasses of Node and their needed virtual function
 * defintitions.
 *
 * @see Node for function descriptions.
 */
...
class SyEmpty : public Node
{
 public:
  SyEmpty(std::string t, std::string v, int l) : Node(t, v, l) {}
  SyEmpty() : Node() {}
  ~SyEmpty() {}
